...
public class Class
{
  ...
  protected final String TEXT_461 = NL + "\t\t// TODO: implement this method" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_462 = NL + "\t\t";
  protected final String TEXT_463 = " eFeature = ";
  ...
  protected final String TEXT_468 = " eFeature = (";
  protected final String TEXT_469 = ");" + NL + "\t\t\t";
  protected final String TEXT_470 = NL + "\t\t\t";
  protected final String TEXT_471 = " helper = OCL_ENV.createOCLHelper();" + NL + "\t\t\thelper.setAttributeContext(";
  protected final String TEXT_472 = ", eFeature);" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_473 = " ocl = eFeature.getEAnnotation(OCL_ANNOTATION_SOURCE);" + NL + "\t\t\tString derive = (String) ocl.getDetails().get(\"derive\");";
  protected final String TEXT_474 = NL + "\t\t\t" + NL + "\t\t\ttry {" + NL + "\t\t\t\t";
  protected final String TEXT_475 = " = helper.createQuery(derive);" + NL + "\t\t\t} catch (";
  protected final String TEXT_476 = " e) {" + NL + "\t\t\t\tthrow new UnsupportedOperationException(e.getLocalizedMessage());" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_477 = "<";
  protected final String TEXT_478 = ", ?, ?> query = OCL_ENV.createQuery(";
  protected final String TEXT_479 = ");" + NL + "\t";
  protected final String TEXT_480 = NL + "\t\t@SuppressWarnings(\"unchecked\")" + NL + "\t\t";
  protected final String TEXT_481 = "<";
  protected final String TEXT_482 = "> result = (";
  protected final String TEXT_483 = "<";
  protected final String TEXT_484 = ">) query.evaluate(this);" + NL + "\t\treturn new ";
  protected final String TEXT_485 = ".UnmodifiableEList<";
  protected final String TEXT_486 = ">(this, eFeature, result.size(), result.toArray());" + NL + "\t";
  protected final String TEXT_487 = NL + "\t\treturn ((";
  protected final String TEXT_488 = ") query.evaluate(this)).";
  protected final String TEXT_489 = "();" + NL + "\t";
  protected final String TEXT_490 = NL + "\t\treturn (";
  protected final String TEXT_491 = ") query.evaluate(this);" + NL + "\t";
  ...
  protected final String TEXT_495 = " basicGet";
  protected final String TEXT_496 = "()" + NL + "\t{";
  protected final String TEXT_497 = NL + "\t\treturn (";
  protected final String TEXT_498 = ")eDynamicGet(";
  protected final String TEXT_499 = ", ";
  protected final String TEXT_500 = ", false, ";
  ...
  protected final String TEXT_521 = " eFeature = ";
  ...
  protected final String TEXT_526 = " eFeature = (";
  protected final String TEXT_527 = ");" + NL + "\t\t\t";
  protected final String TEXT_528 = NL + "\t\t\t";
  protected final String TEXT_529 = " helper = OCL_ENV.createOCLHelper();" + NL + "\t\t\thelper.setAttributeContext(";
  protected final String TEXT_530 = ", eFeature);" + NL + "\t\t\t" + NL + "\t\t\t";
  protected final String TEXT_531 = " ocl = eFeature.getEAnnotation(OCL_ANNOTATION_SOURCE);" + NL + "\t\t\tString derive = (String) ocl.getDetails().get(\"derive\");";
  protected final String TEXT_532 = NL + "\t\t\t" + NL + "\t\t\ttry {" + NL + "\t\t\t\t";
  protected final String TEXT_533 = " = helper.createQuery(derive);" + NL + "\t\t\t} catch (";
  protected final String TEXT_534 = " e) {" + NL + "\t\t\t\tthrow new UnsupportedOperationException(e.getLocalizedMessage());" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_535 = "<";
  protected final String TEXT_536 = ", ?, ?> query = OCL_ENV.createQuery(";
  protected final String TEXT_537 = ");" + NL + "\t";
  protected final String TEXT_538 = NL + "\t\t@SuppressWarnings(\"unchecked\")" + NL + "\t\t";
  protected final String TEXT_539 = "<";
  protected final String TEXT_540 = "> result = (";
  protected final String TEXT_541 = "<";
  protected final String TEXT_542 = ">) query.evaluate(this);" + NL + "\t\treturn new ";
  protected final String TEXT_543 = ".UnmodifiableEList<";
  protected final String TEXT_544 = ">(this, eFeature, result.size(), result.toArray());" + NL + "\t";
  protected final String TEXT_545 = NL + "\t\treturn ((";
  protected final String TEXT_546 = ") query.evaluate(this)).";
  protected final String TEXT_547 = "();" + NL + "\t";
  protected final String TEXT_548 = NL + "\t\treturn (";
  protected final String TEXT_549 = ") query.evaluate(this);" + NL + "\t";
  protected final String TEXT_550 = NL + "\t}" + NL;
  protected final String TEXT_551 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_552 = NL + "\tpublic ";
  protected final String TEXT_553 = " basicSet";
  protected final String TEXT_554 = "(";
  protected final String TEXT_555 = " new";
  protected final String TEXT_556 = ", ";
  protected final String TEXT_557 = " msgs)" + NL + "\t{";
  protected final String TEXT_558 = NL + "\t\tmsgs = eBasicSetContainer((";
  ...
  protected final String TEXT_563 = NL + "\t\tmsgs = eDynamicInverseAdd((";
  protected final String TEXT_564 = ")new";
  protected final String TEXT_565 = ", ";
  protected final String TEXT_566 = ", msgs);";
  protected final String TEXT_567 = NL + "\t\treturn msgs;";
  protected final String TEXT_568 = NL + "\t\tObject old";
  protected final String TEXT_569 = " = eVirtualSet(";
  ...
  protected final String TEXT_578 = NL + "\t\tboolean isSetChange = old";
  protected final String TEXT_579 = " == EVIRTUAL_NO_VALUE;";
  protected final String TEXT_580 = NL + "\t\tboolean old";
  protected final String TEXT_581 = "ESet = (";
  protected final String TEXT_582 = " & ";
  protected final String TEXT_583 = "_ESETFLAG) != 0;";
  protected final String TEXT_584 = NL + "\t\t";
  protected final String TEXT_585 = " |= ";
  protected final String TEXT_586 = "_ESETFLAG;";
  ...
  protected final String TEXT_591 = "ESet = true;";
  protected final String TEXT_592 = NL + "\t\tif (eNotificationRequired())" + NL + "\t\t{";
  ...
  protected final String TEXT_598 = "isSetChange ? null : old";
  ...
  protected final String TEXT_607 = " notification = new ";
  protected final String TEXT_608 = "(this, ";
  protected final String TEXT_609 = ".SET, ";
  protected final String TEXT_610 = ", ";
  protected final String TEXT_611 = "old";
  protected final String TEXT_612 = " == EVIRTUAL_NO_VALUE ? null : old";
  protected final String TEXT_613 = "old";
  protected final String TEXT_614 = ", new";
  protected final String TEXT_615 = ");";
  protected final String TEXT_616 = NL + "\t\t\tif (msgs == null) msgs = notification; else msgs.add(notification);" + NL + "\t\t}";
  protected final String TEXT_617 = NL + "\t\treturn msgs;";
  protected final String TEXT_618 = NL + "\t\treturn ((";
  protected final String TEXT_619 = ".Internal)((";
  protected final String TEXT_620 = ".Internal.Wrapper)get";
  protected final String TEXT_621 = "()).featureMap()).basicAdd(";
  protected final String TEXT_622 = ", new";
  protected final String TEXT_623 = ", msgs);";
  protected final String TEXT_624 = NL + "\t\treturn ((";
  protected final String TEXT_625 = ".Internal)get";
  protected final String TEXT_626 = "()).basicAdd(";
  protected final String TEXT_627 = ", new";
  protected final String TEXT_628 = ", msgs);";
  protected final String TEXT_629 = NL + "\t\t// TODO: implement this method to set the contained '";
  protected final String TEXT_630 = "' ";
  protected final String TEXT_631 = NL + "\t\t// -> this method is automatically invoked to keep the containment relationship in synch" + NL + "\t\t// -> do not modify other features" + NL + "\t\t// -> return msgs, after adding any generated Notification to it (if it is null, a NotificationChain object must be created first)" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_632 = NL + "\t}" + NL;
  protected final String TEXT_633 = NL + "\t/**" + NL + "\t * Sets the value of the '{@link ";
  protected final String TEXT_634 = "#";
  protected final String TEXT_635 = " <em>";
  protected final String TEXT_636 = "</em>}' ";
  protected final String TEXT_637 = ".";
  protected final String TEXT_638 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @param value the new value of the '<em>";
  protected final String TEXT_639 = "</em>' ";
  protected final String TEXT_640 = ".";
  protected final String TEXT_641 = NL + "\t * @see ";
  protected final String TEXT_642 = NL + "\t * @see #isSet";
  protected final String TEXT_643 = "()";
  protected final String TEXT_644 = NL + "\t * @see #unset";
  protected final String TEXT_645 = "()";
  protected final String TEXT_646 = NL + "\t * @see #";
  protected final String TEXT_647 = "()" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_648 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_649 = NL + "\tvoid set";
  protected final String TEXT_650 = "(";
  protected final String TEXT_651 = " value);" + NL;
  protected final String TEXT_652 = NL + "\tpublic void set";
  protected final String TEXT_653 = "_";
  protected final String TEXT_654 = "(";
  protected final String TEXT_655 = " ";
  protected final String TEXT_656 = ")" + NL + "\t{";
  protected final String TEXT_657 = NL + "\t\teDynamicSet(";
  ...
  protected final String TEXT_665 = NL + "\t\teSet(";
  ...
  protected final String TEXT_672 = NL + "\t\tif (new";
  protected final String TEXT_673 = " != eInternalContainer() || (eContainerFeatureID() != ";
  protected final String TEXT_674 = " && new";
  protected final String TEXT_675 = " != null))" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_676 = ".isAncestor(this, ";
  protected final String TEXT_677 = "new";
  protected final String TEXT_678 = "))" + NL + "\t\t\t\tthrow new ";
  protected final String TEXT_679 = "(\"Recursive containment not allowed for \" + toString());";
  protected final String TEXT_680 = NL + "\t\t\t";
  protected final String TEXT_681 = " msgs = null;" + NL + "\t\t\tif (eInternalContainer() != null)" + NL + "\t\t\t\tmsgs = eBasicRemoveFromContainer(msgs);" + NL + "\t\t\tif (new";
  protected final String TEXT_682 = " != null)" + NL + "\t\t\t\tmsgs = ((";
  protected final String TEXT_683 = ")new";
  protected final String TEXT_684 = ").eInverseAdd(this, ";
  protected final String TEXT_685 = ", ";
  protected final String TEXT_686 = ".class, msgs);" + NL + "\t\t\tmsgs = basicSet";
  protected final String TEXT_687 = "(";
  protected final String TEXT_688 = "new";
  protected final String TEXT_689 = ", msgs);" + NL + "\t\t\tif (msgs != null) msgs.dispatch();" + NL + "\t\t}";
  protected final String TEXT_690 = NL + "\t\telse if (eNotificationRequired())" + NL + "\t\t\teNotify(new ";
  ...
  protected final String TEXT_701 = NL + "\t\tif (new";
  protected final String TEXT_702 = " != ";
  protected final String TEXT_703 = ")" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_704 = " msgs = null;" + NL + "\t\t\tif (";
  protected final String TEXT_705 = " != null)";
  protected final String TEXT_706 = NL + "\t\t\t\tmsgs = ((";
  protected final String TEXT_707 = ")";
  protected final String TEXT_708 = ").eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ";
  protected final String TEXT_709 = ", null, msgs);" + NL + "\t\t\tif (new";
  protected final String TEXT_710 = " != null)" + NL + "\t\t\t\tmsgs = ((";
  protected final String TEXT_711 = ")new";
  protected final String TEXT_712 = ").eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ";
  protected final String TEXT_713 = ", null, msgs);";
  protected final String TEXT_714 = NL + "\t\t\t\tmsgs = ((";
  protected final String TEXT_715 = ")";
  protected final String TEXT_716 = ").eInverseRemove(this, ";
  protected final String TEXT_717 = ", ";
  protected final String TEXT_718 = ".class, msgs);" + NL + "\t\t\tif (new";
  protected final String TEXT_719 = " != null)" + NL + "\t\t\t\tmsgs = ((";
  protected final String TEXT_720 = ")new";
  protected final String TEXT_721 = ").eInverseAdd(this, ";
  protected final String TEXT_722 = ", ";
  protected final String TEXT_723 = ".class, msgs);";
  protected final String TEXT_724 = NL + "\t\t\tmsgs = basicSet";
  protected final String TEXT_725 = "(";
  protected final String TEXT_726 = "new";
  protected final String TEXT_727 = ", msgs);" + NL + "\t\t\tif (msgs != null) msgs.dispatch();" + NL + "\t\t}";
  protected final String TEXT_728 = NL + "\t\telse" + NL + "\t\t{";
  protected final String TEXT_729 = NL + "\t\t\tboolean old";
  protected final String TEXT_730 = "ESet = eVirtualIsSet(";
  ...
  protected final String TEXT_743 = "ESet = true;";
  protected final String TEXT_744 = NL + "\t\t\tif (eNotificationRequired())" + NL + "\t\t\t\teNotify(new ";
  ...
  protected final String TEXT_762 = "_EFLAG) != 0;";
  protected final String TEXT_763 = NL + "\t\t";
  protected final String TEXT_764 = " old";
  protected final String TEXT_765 = " = ";
  protected final String TEXT_766 = "_EFLAG_VALUES[(";
  protected final String TEXT_767 = " & ";
  protected final String TEXT_768 = "_EFLAG) >>> ";
  protected final String TEXT_769 = "_EFLAG_OFFSET];";
  protected final String TEXT_770 = NL + "\t\tif (new";
  protected final String TEXT_771 = ") ";
  protected final String TEXT_772 = " |= ";
  protected final String TEXT_773 = "_EFLAG; else ";
  protected final String TEXT_774 = " &= ~";
  protected final String TEXT_775 = "_EFLAG;";
  protected final String TEXT_776 = NL + "\t\tif (new";
  protected final String TEXT_777 = " == null) new";
  protected final String TEXT_778 = " = ";
  protected final String TEXT_779 = "_EDEFAULT;" + NL + "\t\t";
  protected final String TEXT_780 = " = ";
  protected final String TEXT_781 = " & ~";
  protected final String TEXT_782 = "_EFLAG | ";
  protected final String TEXT_783 = "new";
  protected final String TEXT_784 = ".ordinal()";
  protected final String TEXT_785 = ".VALUES.indexOf(new";
  protected final String TEXT_786 = ")";
  protected final String TEXT_787 = " << ";
  protected final String TEXT_788 = "_EFLAG_OFFSET;";
  ...
  protected final String TEXT_813 = NL + "\t\tObject old";
  protected final String TEXT_814 = " = eVirtualSet(";
  protected final String TEXT_815 = ", ";
  protected final String TEXT_816 = ");";
  protected final String TEXT_817 = NL + "\t\tboolean isSetChange = old";
  protected final String TEXT_818 = " == EVIRTUAL_NO_VALUE;";
  protected final String TEXT_819 = NL + "\t\tboolean old";
  protected final String TEXT_820 = "ESet = (";
  protected final String TEXT_821 = " & ";
  protected final String TEXT_822 = "_ESETFLAG) != 0;";
  protected final String TEXT_823 = NL + "\t\t";
  protected final String TEXT_824 = " |= ";
  protected final String TEXT_825 = "_ESETFLAG;";
  ...
  protected final String TEXT_830 = "ESet = true;";
  protected final String TEXT_831 = NL + "\t\tif (eNotificationRequired())" + NL + "\t\t\teNotify(new ";
  protected final String TEXT_832 = "(this, ";
  protected final String TEXT_833 = ".SET, ";
  protected final String TEXT_834 = ", ";
  protected final String TEXT_835 = "isSetChange ? ";
  ...
  protected final String TEXT_857 = ".Internal)((";
  protected final String TEXT_858 = ".Internal.Wrapper)get";
  protected final String TEXT_859 = "()).featureMap()).set(";
  ...
  protected final String TEXT_867 = ".Internal)get";
  ...
  protected final String TEXT_876 = NL + "\t\t// TODO: implement this method to set the '";
  protected final String TEXT_877 = "' ";
  protected final String TEXT_878 = NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  ...
  protected final String TEXT_881 = NL + "\tpublic ";
  protected final String TEXT_882 = " basicUnset";
  protected final String TEXT_883 = "(";
  protected final String TEXT_884 = " msgs)" + NL + "\t{";
  protected final String TEXT_885 = NL + "\t\treturn eDynamicInverseRemove((";
  protected final String TEXT_886 = ")";
  protected final String TEXT_887 = "basicGet";
  protected final String TEXT_888 = "(), ";
  protected final String TEXT_889 = ", msgs);";
  protected final String TEXT_890 = "Object old";
  protected final String TEXT_891 = " = ";
  protected final String TEXT_892 = "eVirtualUnset(";
  ...
  protected final String TEXT_900 = NL + "\t\tboolean isSetChange = old";
  protected final String TEXT_901 = " != EVIRTUAL_NO_VALUE;";
  protected final String TEXT_902 = NL + "\t\tboolean old";
  protected final String TEXT_903 = "ESet = (";
  protected final String TEXT_904 = " & ";
  protected final String TEXT_905 = "_ESETFLAG) != 0;";
  protected final String TEXT_906 = NL + "\t\t";
  protected final String TEXT_907 = " &= ~";
  protected final String TEXT_908 = "_ESETFLAG;";
  protected final String TEXT_909 = NL + "\t\tboolean old";
  protected final String TEXT_910 = "ESet = ";
  protected final String TEXT_911 = "ESet;";
  protected final String TEXT_912 = NL + "\t\t";
  protected final String TEXT_913 = "ESet = false;";
  protected final String TEXT_914 = NL + "\t\tif (eNotificationRequired())" + NL + "\t\t{" + NL + "\t\t\t";
  ...
  protected final String TEXT_919 = "isSetChange ? old";
  ...
  protected final String TEXT_926 = ");" + NL + "\t\t\tif (msgs == null) msgs = notification; else msgs.add(notification);" + NL + "\t\t}" + NL + "\t\treturn msgs;";
  protected final String TEXT_927 = NL + "\t\t// TODO: implement this method to unset the contained '";
  ...
  protected final String TEXT_931 = NL + "\t/**" + NL + "\t * Unsets the value of the '{@link ";
  protected final String TEXT_932 = "#";
  protected final String TEXT_933 = " <em>";
  protected final String TEXT_934 = "</em>}' ";
  protected final String TEXT_935 = ".";
  protected final String TEXT_936 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_937 = NL + "\t * @see #isSet";
  protected final String TEXT_938 = "()";
  protected final String TEXT_939 = NL + "\t * @see #";
  protected final String TEXT_940 = "()";
  protected final String TEXT_941 = NL + "\t * @see #set";
  protected final String TEXT_942 = "(";
  protected final String TEXT_943 = ")";
  protected final String TEXT_944 = NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_945 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_946 = NL + "\tvoid unset";
  protected final String TEXT_947 = "();" + NL;
  protected final String TEXT_948 = NL + "\tpublic void unset";
  protected final String TEXT_949 = "_";
  protected final String TEXT_950 = "()" + NL + "\t{";
  protected final String TEXT_951 = NL + "\t\teDynamicUnset(";
  protected final String TEXT_952 = ", ";
  protected final String TEXT_953 = ");";
  protected final String TEXT_954 = NL + "\t\teUnset(";
  protected final String TEXT_955 = ");";
  protected final String TEXT_956 = NL + "\t\t";
  protected final String TEXT_957 = " ";
  protected final String TEXT_958 = " = (";
  protected final String TEXT_959 = ")eVirtualGet(";
  protected final String TEXT_960 = ");";
  protected final String TEXT_961 = NL + "\t\tif (";
  protected final String TEXT_962 = " != null) ((";
  protected final String TEXT_963 = ".Unsettable";
  protected final String TEXT_964 = ")";
  protected final String TEXT_965 = ").unset();";
  protected final String TEXT_966 = NL + "\t\t";
  protected final String TEXT_967 = " ";
  protected final String TEXT_968 = " = (";
  protected final String TEXT_969 = ")eVirtualGet(";
  protected final String TEXT_970 = ");";
  protected final String TEXT_971 = NL + "\t\tif (";
  protected final String TEXT_972 = " != null)" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_973 = " msgs = null;";
  protected final String TEXT_974 = NL + "\t\t\tmsgs = ((";
  protected final String TEXT_975 = ")";
  protected final String TEXT_976 = ").eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ";
  protected final String TEXT_977 = ", null, msgs);";
  protected final String TEXT_978 = NL + "\t\t\tmsgs = ((";
  protected final String TEXT_979 = ")";
  protected final String TEXT_980 = ").eInverseRemove(this, ";
  protected final String TEXT_981 = ", ";
  protected final String TEXT_982 = ".class, msgs);";
  protected final String TEXT_983 = NL + "\t\t\tmsgs = basicUnset";
  protected final String TEXT_984 = "(msgs);" + NL + "\t\t\tif (msgs != null) msgs.dispatch();" + NL + "\t\t}" + NL + "\t\telse" + NL + "\t\t{";
  ...
  protected final String TEXT_999 = "ESet = false;";
  ...
  protected final String TEXT_1003 = ", null, null, old";
  ...
  protected final String TEXT_1014 = "_EFLAG_VALUES[(";
  protected final String TEXT_1015 = " & ";
  protected final String TEXT_1016 = "_EFLAG) >>> ";
  protected final String TEXT_1017 = "_EFLAG_OFFSET];";
  protected final String TEXT_1018 = NL + "\t\tObject old";
  protected final String TEXT_1019 = " = eVirtualUnset(";
  protected final String TEXT_1020 = ");";
  protected final String TEXT_1021 = NL + "\t\t";
  protected final String TEXT_1022 = " old";
  protected final String TEXT_1023 = " = ";
  protected final String TEXT_1024 = ";";
  protected final String TEXT_1025 = NL + "\t\tboolean isSetChange = old";
  protected final String TEXT_1026 = " != EVIRTUAL_NO_VALUE;";
  protected final String TEXT_1027 = NL + "\t\tboolean old";
  protected final String TEXT_1028 = "ESet = (";
  protected final String TEXT_1029 = " & ";
  protected final String TEXT_1030 = "_ESETFLAG) != 0;";
  ...
  protected final String TEXT_1076 = "isSetChange ? old";
  ...
  protected final String TEXT_1081 = "isSetChange";
  ...
  protected final String TEXT_1087 = ".Internal.Wrapper)get";
  protected final String TEXT_1088 = "()).featureMap()).clear(";
  protected final String TEXT_1089 = ");";
  protected final String TEXT_1090 = NL + "\t\t((";
  protected final String TEXT_1091 = ".Internal)get";
  protected final String TEXT_1092 = "()).clear(";
  protected final String TEXT_1093 = ");";
  protected final String TEXT_1094 = NL + "\t\t";
  protected final String TEXT_1095 = NL + "\t\t// TODO: implement this method to unset the '";
  protected final String TEXT_1096 = "' ";
  protected final String TEXT_1097 = NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_1098 = NL + "\t}" + NL;
  protected final String TEXT_1099 = NL + "\t/**" + NL + "\t * Returns whether the value of the '{@link ";
  protected final String TEXT_1100 = "#";
  protected final String TEXT_1101 = " <em>";
  protected final String TEXT_1102 = "</em>}' ";
  protected final String TEXT_1103 = " is set.";
  protected final String TEXT_1104 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return whether the value of the '<em>";
  protected final String TEXT_1105 = "</em>' ";
  protected final String TEXT_1106 = " is set.";
  protected final String TEXT_1107 = NL + "\t * @see #unset";
  protected final String TEXT_1108 = "()";
  protected final String TEXT_1109 = NL + "\t * @see #";
  protected final String TEXT_1110 = "()";
  protected final String TEXT_1111 = NL + "\t * @see #set";
  ...
  protected final String TEXT_1116 = NL + "\tboolean isSet";
  protected final String TEXT_1117 = "();" + NL;
  protected final String TEXT_1118 = NL + "\tpublic boolean isSet";
  protected final String TEXT_1119 = "_";
  protected final String TEXT_1120 = "()" + NL + "\t{";
  protected final String TEXT_1121 = NL + "\t\treturn eDynamicIsSet(";
  protected final String TEXT_1122 = ", ";
  protected final String TEXT_1123 = ");";
  protected final String TEXT_1124 = NL + "\t\treturn eIsSet(";
  ...
  protected final String TEXT_1133 = ".Unsettable";
  protected final String TEXT_1134 = ")";
  protected final String TEXT_1135 = ").isSet();";
  protected final String TEXT_1136 = NL + "\t\treturn eVirtualIsSet(";
  protected final String TEXT_1137 = ");";
  protected final String TEXT_1138 = NL + "\t\treturn (";
  protected final String TEXT_1139 = " & ";
  protected final String TEXT_1140 = "_ESETFLAG) != 0;";
  protected final String TEXT_1141 = NL + "\t\treturn ";
  protected final String TEXT_1142 = "ESet;";
  protected final String TEXT_1143 = NL + "\t\treturn !((";
  protected final String TEXT_1144 = ".Internal)((";
  protected final String TEXT_1145 = ".Internal.Wrapper)get";
  protected final String TEXT_1146 = "()).featureMap()).isEmpty(";
  protected final String TEXT_1147 = ");";
  protected final String TEXT_1148 = NL + "\t\treturn !((";
  protected final String TEXT_1149 = ".Internal)get";
  protected final String TEXT_1150 = "()).isEmpty(";
  protected final String TEXT_1151 = ");";
  protected final String TEXT_1152 = NL + "\t\t";
  protected final String TEXT_1153 = NL + "\t\t// TODO: implement this method to return whether the '";
  protected final String TEXT_1154 = "' ";
  protected final String TEXT_1155 = " is set" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_1156 = NL + "\t}" + NL;
  protected final String TEXT_1157 = NL + "\t/**";
  protected final String TEXT_1158 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_1159 = NL + "\t * <!-- begin-model-doc -->";
  protected final String TEXT_1160 = NL + "\t * ";
  protected final String TEXT_1161 = NL + "\t * @param ";
  protected final String TEXT_1162 = NL + "\t *   ";
  protected final String TEXT_1163 = NL + "\t * @param ";
  protected final String TEXT_1164 = " ";
  protected final String TEXT_1165 = NL + "\t * <!-- end-model-doc -->";
  protected final String TEXT_1166 = NL + "\t * @model ";
  protected final String TEXT_1167 = NL + "\t *        ";
  protected final String TEXT_1168 = NL + "\t * @model";
  protected final String TEXT_1169 = NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1170 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_1182 = NL + "\t\t// TODO: implement this method" + NL + "\t\t// -> specify the condition that violates the invariant" + NL + "\t\t// -> verify the details of the diagnostic, including severity and message" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tif (false)" + NL + "\t\t{" + NL + "\t\t\tif (";
  protected final String TEXT_1183 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_1184 = ".add" + NL + "\t\t\t\t\t(new ";
  protected final String TEXT_1185 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_1186 = ".ERROR," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_1187 = ".DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_1188 = ".";
  protected final String TEXT_1189 = "," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_1190 = ".INSTANCE.getString(\"_UI_GenericInvariant_diagnostic\", new Object[] { \"";
  protected final String TEXT_1191 = "\", ";
  protected final String TEXT_1192 = ".getObjectLabel(this, ";
  protected final String TEXT_1193 = ") }),";
  protected final String TEXT_1194 = NL + "\t\t\t\t\t\t new Object [] { this }));" + NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn true;";
  protected final String TEXT_1195 = NL + "\t\t// TODO: implement this method" + NL + "\t\t// Ensure that you remove @generated or mark it @generated NOT" + NL + "\t\tthrow new UnsupportedOperationException();";
  protected final String TEXT_1196 = NL + "\t\tif (";
  protected final String TEXT_1197 = " == null) {" + NL + "\t\t\t";
  protected final String TEXT_1198 = " eOperation = ";
  protected final String TEXT_1199 = ".getEOperations().get(";
  protected final String TEXT_1200 = ");" + NL + "\t\t\t";
  protected final String TEXT_1201 = ".Helper helper = OCL_ENV.createOCLHelper();" + NL + "\t\t\thelper.setOperationContext(";
  protected final String TEXT_1202 = ", eOperation);" + NL + "\t\t\t";
  protected final String TEXT_1203 = " ocl = eOperation.getEAnnotation(OCL_ANNOTATION_SOURCE);" + NL + "\t\t\tString body = ocl.getDetails().get(\"body\");";
  protected final String TEXT_1204 = NL + "\t\t\t" + NL + "\t\t\ttry {" + NL + "\t\t\t\t";
  protected final String TEXT_1205 = " = helper.createQuery(body);" + NL + "\t\t\t} catch (";
  protected final String TEXT_1206 = " e) {" + NL + "\t\t\t\tthrow new UnsupportedOperationException(e.getLocalizedMessage());" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_1207 = "<";
  protected final String TEXT_1208 = ", ?, ?> query = OCL_ENV.createQuery(";
  protected final String TEXT_1209 = ");" + NL + "\t";
  protected final String TEXT_1210 = " " + NL + "\t\t";
  protected final String TEXT_1211 = "<?, ?, ?, ?, ?> evalEnv = query.getEvaluationEnvironment();" + NL + "\t\t";
  protected final String TEXT_1212 = NL + "\t\tevalEnv.add(\"";
  protected final String TEXT_1213 = "\", ";
  protected final String TEXT_1214 = ");";
  protected final String TEXT_1215 = NL + "\t  ";
  protected final String TEXT_1216 = NL + "\t\t@SuppressWarnings(\"unchecked\")" + NL + "\t\t";
  protected final String TEXT_1217 = "<";
  protected final String TEXT_1218 = "> result = (";
  protected final String TEXT_1219 = "<";
  protected final String TEXT_1220 = ">) query.evaluate(this);" + NL + "\t\treturn new ";
  protected final String TEXT_1221 = ".UnmodifiableEList<";
  protected final String TEXT_1222 = ">(result.size(), result.toArray());" + NL + "\t";
  protected final String TEXT_1223 = NL + "\t\treturn ((";
  protected final String TEXT_1224 = ") query.evaluate(this)).";
  protected final String TEXT_1225 = "();" + NL + "\t";
  protected final String TEXT_1226 = NL + "\t\treturn (";
  protected final String TEXT_1227 = ") query.evaluate(this);" + NL + "\t";
  ...
  protected final String TEXT_1230 = NL + "\t@SuppressWarnings(\"unchecked\")";
  protected final String TEXT_1231 = NL + "\t@Override";
  protected final String TEXT_1232 = NL + "\tpublic ";
  protected final String TEXT_1233 = " eInverseAdd(";
  ...
  protected final String TEXT_1243 = "()).eMap()).basicAdd(otherEnd, msgs);";
  protected final String TEXT_1244 = NL + "\t\t\t\treturn (";
  protected final String TEXT_1245 = "()).basicAdd(otherEnd, msgs);";
  protected final String TEXT_1246 = NL + "\t\t\t\tif (eInternalContainer() != null)" + NL + "\t\t\t\t\tmsgs = eBasicRemoveFromContainer(msgs);";
  protected final String TEXT_1247 = NL + "\t\t\t\treturn basicSet";
  protected final String TEXT_1248 = "((";
  protected final String TEXT_1249 = ")otherEnd, msgs);";
  protected final String TEXT_1250 = NL + "\t\t\t\treturn eBasicSetContainer(otherEnd, ";
  protected final String TEXT_1251 = ", msgs);";
  protected final String TEXT_1252 = NL + "\t\t\t\t";
  protected final String TEXT_1253 = " ";
  protected final String TEXT_1254 = " = (";
  protected final String TEXT_1255 = ")eVirtualGet(";
  ...
  protected final String TEXT_1260 = "basicGet";
  protected final String TEXT_1261 = "();";
  protected final String TEXT_1262 = NL + "\t\t\t\tif (";
  protected final String TEXT_1263 = " != null)";
  protected final String TEXT_1264 = NL + "\t\t\t\t\tmsgs = ((";
  protected final String TEXT_1265 = ")";
  protected final String TEXT_1266 = ").eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ";
  protected final String TEXT_1267 = ", null, msgs);";
  protected final String TEXT_1268 = NL + "\t\t\t\t\tmsgs = ((";
  protected final String TEXT_1269 = ")";
  protected final String TEXT_1270 = ").eInverseRemove(this, ";
  protected final String TEXT_1271 = ", ";
  protected final String TEXT_1272 = ".class, msgs);";
  protected final String TEXT_1273 = NL + "\t\t\t\treturn basicSet";
  protected final String TEXT_1274 = "((";
  protected final String TEXT_1275 = ")otherEnd, msgs);";
  protected final String TEXT_1276 = NL + "\t\t}";
  protected final String TEXT_1277 = NL + "\t\treturn super.eInverseAdd(otherEnd, featureID, msgs);";
  protected final String TEXT_1278 = NL + "\t\treturn eDynamicInverseAdd(otherEnd, featureID, msgs);";
  ...
  protected final String TEXT_1282 = NL + "\tpublic ";
  protected final String TEXT_1283 = " eInverseRemove(";
  protected final String TEXT_1284 = " otherEnd, int featureID, ";
  protected final String TEXT_1285 = " msgs)" + NL + "\t{" + NL + "\t\tswitch (featureID";
  protected final String TEXT_1286 = ")" + NL + "\t\t{";
  protected final String TEXT_1287 = NL + "\t\t\tcase ";
  protected final String TEXT_1288 = ":";
  protected final String TEXT_1289 = NL + "\t\t\t\treturn ((";
  protected final String TEXT_1290 = ")((";
  protected final String TEXT_1291 = ".InternalMapView";
  protected final String TEXT_1292 = ")";
  protected final String TEXT_1293 = "()).eMap()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_1294 = NL + "\t\t\t\treturn ((";
  protected final String TEXT_1295 = ")((";
  protected final String TEXT_1296 = ".Internal.Wrapper)";
  protected final String TEXT_1297 = "()).featureMap()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_1298 = NL + "\t\t\t\treturn ((";
  protected final String TEXT_1299 = ")";
  protected final String TEXT_1300 = "()).basicRemove(otherEnd, msgs);";
  protected final String TEXT_1301 = NL + "\t\t\t\treturn eBasicSetContainer(null, ";
  protected final String TEXT_1302 = ", msgs);";
  protected final String TEXT_1303 = NL + "\t\t\t\treturn basicUnset";
  protected final String TEXT_1304 = "(msgs);";
  protected final String TEXT_1305 = NL + "\t\t\t\treturn basicSet";
  protected final String TEXT_1306 = "(null, msgs);";
  protected final String TEXT_1307 = NL + "\t\t}";
  protected final String TEXT_1308 = NL + "\t\treturn super.eInverseRemove(otherEnd, featureID, msgs);";
  protected final String TEXT_1309 = NL + "\t\treturn eDynamicInverseRemove(otherEnd, featureID, msgs);";
  protected final String TEXT_1310 = NL + "\t}" + NL;
  protected final String TEXT_1311 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1312 = NL + "\t@Override";
  protected final String TEXT_1313 = NL + "\tpublic ";
  protected final String TEXT_1314 = " eBasicRemoveFromContainerFeature(";
  protected final String TEXT_1315 = " msgs)" + NL + "\t{" + NL + "\t\tswitch (eContainerFeatureID()";
  protected final String TEXT_1316 = ")" + NL + "\t\t{";
  protected final String TEXT_1317 = NL + "\t\t\tcase ";
  protected final String TEXT_1318 = ":" + NL + "\t\t\t\treturn eInternalContainer().eInverseRemove(this, ";
  protected final String TEXT_1319 = ", ";
  protected final String TEXT_1320 = ".class, msgs);";
  protected final String TEXT_1321 = NL + "\t\t}";
  protected final String TEXT_1322 = NL + "\t\treturn super.eBasicRemoveFromContainerFeature(msgs);";
  protected final String TEXT_1323 = NL + "\t\treturn eDynamicBasicRemoveFromContainer(msgs);";
  protected final String TEXT_1324 = NL + "\t}" + NL;
  protected final String TEXT_1325 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1326 = NL + "\t@Override";
  protected final String TEXT_1327 = NL + "\tpublic Object eGet(int featureID, boolean resolve, boolean coreType)" + NL + "\t{" + NL + "\t\tswitch (featureID";
  ...
  protected final String TEXT_1334 = "() ? Boolean.TRUE : Boolean.FALSE;";
  protected final String TEXT_1335 = NL + "\t\t\t\treturn new ";
  protected final String TEXT_1336 = "(";
  protected final String TEXT_1337 = "());";
  protected final String TEXT_1338 = NL + "\t\t\t\tif (resolve) return ";
  protected final String TEXT_1339 = "();" + NL + "\t\t\t\treturn basicGet";
  protected final String TEXT_1340 = "();";
  protected final String TEXT_1341 = NL + "\t\t\t\tif (coreType) return ((";
  protected final String TEXT_1342 = ".InternalMapView";
  protected final String TEXT_1343 = ")";
  protected final String TEXT_1344 = "()).eMap();" + NL + "\t\t\t\telse return ";
  protected final String TEXT_1345 = "();";
  protected final String TEXT_1346 = NL + "\t\t\t\tif (coreType) return ";
  protected final String TEXT_1347 = "();" + NL + "\t\t\t\telse return ";
  protected final String TEXT_1348 = "().map();";
  protected final String TEXT_1349 = NL + "\t\t\t\tif (coreType) return ((";
  protected final String TEXT_1350 = ".Internal.Wrapper)";
  protected final String TEXT_1351 = "()).featureMap();" + NL + "\t\t\t\treturn ";
  protected final String TEXT_1352 = "();";
  protected final String TEXT_1353 = NL + "\t\t\t\tif (coreType) return ";
  protected final String TEXT_1354 = "();" + NL + "\t\t\t\treturn ((";
  protected final String TEXT_1355 = ".Internal)";
  protected final String TEXT_1356 = "()).getWrapper();";
  protected final String TEXT_1357 = NL + "\t\t\t\treturn ";
  protected final String TEXT_1358 = "();";
  protected final String TEXT_1359 = NL + "\t\t}";
  protected final String TEXT_1360 = NL + "\t\treturn super.eGet(featureID, resolve, coreType);";
  protected final String TEXT_1361 = NL + "\t\treturn eDynamicGet(featureID, resolve, coreType);";
  protected final String TEXT_1362 = NL + "\t}" + NL;
  protected final String TEXT_1363 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1364 = NL + "\t@SuppressWarnings(\"unchecked\")";
  protected final String TEXT_1365 = NL + "\t@Override";
  protected final String TEXT_1366 = NL + "\tpublic void eSet(int featureID, Object newValue)" + NL + "\t{" + NL + "\t\tswitch (featureID";
  protected final String TEXT_1367 = ")" + NL + "\t\t{";
  protected final String TEXT_1368 = NL + "\t\t\tcase ";
  ...
  protected final String TEXT_1373 = "()).featureMap()).set(newValue);";
  protected final String TEXT_1374 = NL + "\t\t\t\t((";
  protected final String TEXT_1375 = ".Internal)";
  protected final String TEXT_1376 = "()).set(newValue);";
  protected final String TEXT_1377 = NL + "\t\t\t\t((";
  protected final String TEXT_1378 = ".Setting)((";
  protected final String TEXT_1379 = ".InternalMapView";
  protected final String TEXT_1380 = ")";
  protected final String TEXT_1381 = "()).eMap()).set(newValue);";
  protected final String TEXT_1382 = NL + "\t\t\t\t((";
  protected final String TEXT_1383 = ".Setting)";
  protected final String TEXT_1384 = "()).set(newValue);";
  protected final String TEXT_1385 = NL + "\t\t\t\t";
  protected final String TEXT_1386 = "().clear();" + NL + "\t\t\t\t";
  protected final String TEXT_1387 = "().addAll((";
  protected final String TEXT_1388 = "<? extends ";
  protected final String TEXT_1389 = ">";
  protected final String TEXT_1390 = ")newValue);";
  protected final String TEXT_1391 = NL + "\t\t\t\tset";
  protected final String TEXT_1392 = "(((";
  protected final String TEXT_1393 = ")newValue).";
  ...
  protected final String TEXT_1399 = "newValue);";
  protected final String TEXT_1400 = NL + "\t\t\t\treturn;";
  protected final String TEXT_1401 = NL + "\t\t}";
  protected final String TEXT_1402 = NL + "\t\tsuper.eSet(featureID, newValue);";
  protected final String TEXT_1403 = NL + "\t\teDynamicSet(featureID, newValue);";
  protected final String TEXT_1404 = NL + "\t}" + NL;
  protected final String TEXT_1405 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1406 = NL + "\t@Override";
  protected final String TEXT_1407 = NL + "\tpublic void eUnset(int featureID)" + NL + "\t{" + NL + "\t\tswitch (featureID";
  protected final String TEXT_1408 = ")" + NL + "\t\t{";
  protected final String TEXT_1409 = NL + "\t\t\tcase ";
  protected final String TEXT_1410 = ":";
  protected final String TEXT_1411 = NL + "\t\t\t\t((";
  protected final String TEXT_1412 = ".Internal.Wrapper)";
  protected final String TEXT_1413 = "()).featureMap().clear();";
  protected final String TEXT_1414 = NL + "\t\t\t\t";
  protected final String TEXT_1415 = "().clear();";
  protected final String TEXT_1416 = NL + "\t\t\t\tunset";
  protected final String TEXT_1417 = "();";
  protected final String TEXT_1418 = NL + "\t\t\t\tset";
  ...
  protected final String TEXT_1426 = NL + "\t\tsuper.eUnset(featureID);";
  protected final String TEXT_1427 = NL + "\t\teDynamicUnset(featureID);";
  protected final String TEXT_1428 = NL + "\t}" + NL;
  protected final String TEXT_1429 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1430 = NL + "\t@SuppressWarnings(\"unchecked\")";
  protected final String TEXT_1431 = NL + "\t@Override";
  protected final String TEXT_1432 = NL + "\tpublic boolean eIsSet(int featureID)" + NL + "\t{" + NL + "\t\tswitch (featureID";
  ...
  protected final String TEXT_1437 = ".Internal.Wrapper)";
  protected final String TEXT_1438 = "()).featureMap().isEmpty();";
  protected final String TEXT_1439 = NL + "\t\t\t\treturn ";
  protected final String TEXT_1440 = " != null && !";
  protected final String TEXT_1441 = ".featureMap().isEmpty();";
  ...
  protected final String TEXT_1451 = ".isEmpty();";
  protected final String TEXT_1452 = NL + "\t\t\t\treturn !";
  protected final String TEXT_1453 = "().isEmpty();";
  ...
  protected final String TEXT_1460 = NL + "\t\t\t\treturn basicGet";
  ...
  protected final String TEXT_1479 = NL + "\t\t\t\treturn eVirtualGet(";
  ...
  protected final String TEXT_1489 = ".equals(";
  ...
  protected final String TEXT_1494 = ")eVirtualGet(";
  ...
  protected final String TEXT_1499 = ".equals(";
  ...
  protected final String TEXT_1507 = NL + "\t\treturn super.eIsSet(featureID);";
  protected final String TEXT_1508 = NL + "\t\treturn eDynamicIsSet(featureID);";
  ...
  protected final String TEXT_1512 = NL + "\tpublic int eBaseStructuralFeatureID(int derivedFeatureID, Class";
  protected final String TEXT_1513 = " baseClass)" + NL + "\t{";
  protected final String TEXT_1514 = NL + "\t\tif (baseClass == ";
  protected final String TEXT_1515 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (derivedFeatureID";
  ...
  protected final String TEXT_1521 = NL + "\t\treturn super.eBaseStructuralFeatureID(derivedFeatureID, baseClass);" + NL + "\t}";
  protected final String TEXT_1522 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1523 = NL + "\t@Override";
  protected final String TEXT_1524 = NL + "\tpublic int eDerivedStructuralFeatureID(int baseFeatureID, Class";
  protected final String TEXT_1525 = " baseClass)" + NL + "\t{";
  protected final String TEXT_1526 = NL + "\t\tif (baseClass == ";
  protected final String TEXT_1527 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseFeatureID)" + NL + "\t\t\t{";
  ...
  protected final String TEXT_1532 = NL + "\t\tif (baseClass == ";
  protected final String TEXT_1533 = ".class)" + NL + "\t\t{" + NL + "\t\t\tswitch (baseFeatureID";
  ...
  protected final String TEXT_1542 = NL + "\tprotected Object[] eVirtualValues()" + NL + "\t{" + NL + "\t\treturn ";
  protected final String TEXT_1543 = ";" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1544 = NL + "\t@Override";
  protected final String TEXT_1545 = NL + "\tprotected void eSetVirtualValues(Object[] newValues)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1546 = " = newValues;" + NL + "\t}" + NL;
  ...
  protected final String TEXT_1549 = NL + "\tprotected int eVirtualIndexBits(int offset)" + NL + "\t{" + NL + "\t\tswitch (offset)" + NL + "\t\t{";
  protected final String TEXT_1550 = NL + "\t\t\tcase ";
  protected final String TEXT_1551 = " :" + NL + "\t\t\t\treturn ";
  protected final String TEXT_1552 = ";";
  protected final String TEXT_1553 = NL + "\t\t\tdefault :" + NL + "\t\t\t\tthrow new IndexOutOfBoundsException();" + NL + "\t\t}" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1554 = NL + "\t@Override";
  protected final String TEXT_1555 = NL + "\tprotected void eSetVirtualIndexBits(int offset, int newIndexBits)" + NL + "\t{" + NL + "\t\tswitch (offset)" + NL + "\t\t{";
  protected final String TEXT_1556 = NL + "\t\t\tcase ";
  protected final String TEXT_1557 = " :" + NL + "\t\t\t\t";
  protected final String TEXT_1558 = " = newIndexBits;" + NL + "\t\t\t\tbreak;";
  protected final String TEXT_1559 = NL + "\t\t\tdefault :" + NL + "\t\t\t\tthrow new IndexOutOfBoundsException();" + NL + "\t\t}" + NL + "\t}" + NL;
  ...
  protected final String TEXT_1562 = NL + "\tpublic String toString()" + NL + "\t{" + NL + "\t\tif (eIsProxy()) return super.toString();" + NL + "" + NL + "\t\tStringBuffer result = new StringBuffer(super.toString());";
  protected final String TEXT_1563 = NL + "\t\tresult.append(\" (";
  protected final String TEXT_1564 = ": \");";
  protected final String TEXT_1565 = NL + "\t\tresult.append(\", ";
  protected final String TEXT_1566 = ": \");";
  protected final String TEXT_1567 = NL + "\t\tif (eVirtualIsSet(";
  protected final String TEXT_1568 = ")) result.append(eVirtualGet(";
  protected final String TEXT_1569 = ")); else result.append(\"<unset>\");";
  protected final String TEXT_1570 = NL + "\t\tif (";
  protected final String TEXT_1571 = "(";
  protected final String TEXT_1572 = " & ";
  protected final String TEXT_1573 = "_ESETFLAG) != 0";
  protected final String TEXT_1574 = "ESet";
  protected final String TEXT_1575 = ") result.append((";
  protected final String TEXT_1576 = " & ";
  protected final String TEXT_1577 = "_EFLAG) != 0); else result.append(\"<unset>\");";
  ...
  protected final String TEXT_1584 = "_EFLAG_VALUES[(";
  protected final String TEXT_1585 = " & ";
  protected final String TEXT_1586 = "_EFLAG) >>> ";
  protected final String TEXT_1587 = "_EFLAG_OFFSET]); else result.append(\"<unset>\");";
  protected final String TEXT_1588 = NL + "\t\tif (";
  protected final String TEXT_1589 = "(";
  protected final String TEXT_1590 = " & ";
  protected final String TEXT_1591 = "_ESETFLAG) != 0";
  protected final String TEXT_1592 = "ESet";
  protected final String TEXT_1593 = ") result.append(";
  protected final String TEXT_1594 = "); else result.append(\"<unset>\");";
  protected final String TEXT_1595 = NL + "\t\tresult.append(eVirtualGet(";
  ...
  protected final String TEXT_1600 = "_EFLAG) != 0);";
  protected final String TEXT_1601 = NL + "\t\tresult.append(";
  protected final String TEXT_1602 = "_EFLAG_VALUES[(";
  protected final String TEXT_1603 = " & ";
  protected final String TEXT_1604 = "_EFLAG) >>> ";
  protected final String TEXT_1605 = "_EFLAG_OFFSET]);";
  protected final String TEXT_1606 = NL + "\t\tresult.append(";
  protected final String TEXT_1607 = ");";
  protected final String TEXT_1608 = NL + "\t\tresult.append(')');" + NL + "\t\treturn result.toString();" + NL + "\t}" + NL;
  protected final String TEXT_1609 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected int hash = -1;" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic int getHash()" + NL + "\t{" + NL + "\t\tif (hash == -1)" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_1610 = " theKey = getKey();" + NL + "\t\t\thash = (theKey == null ? 0 : theKey.hashCode());" + NL + "\t\t}" + NL + "\t\treturn hash;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void setHash(int hash)" + NL + "\t{" + NL + "\t\tthis.hash = hash;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_1611 = " getKey()" + NL + "\t{";
  protected final String TEXT_1612 = NL + "\t\treturn new ";
  protected final String TEXT_1613 = "(getTypedKey());";
  protected final String TEXT_1614 = NL + "\t\treturn getTypedKey();";
  protected final String TEXT_1615 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void setKey(";
  protected final String TEXT_1616 = " key)" + NL + "\t{";
  protected final String TEXT_1617 = NL + "\t\tgetTypedKey().addAll(";
  protected final String TEXT_1618 = "(";
  protected final String TEXT_1619 = ")";
  protected final String TEXT_1620 = "key);";
  protected final String TEXT_1621 = NL + "\t\tsetTypedKey(key);";
  protected final String TEXT_1622 = NL + "\t\tsetTypedKey(((";
  protected final String TEXT_1623 = ")key).";
  protected final String TEXT_1624 = "());";
  protected final String TEXT_1625 = NL + "\t\tsetTypedKey((";
  protected final String TEXT_1626 = ")key);";
  protected final String TEXT_1627 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_1628 = " getValue()" + NL + "\t{";
  protected final String TEXT_1629 = NL + "\t\treturn new ";
  protected final String TEXT_1630 = "(getTypedValue());";
  protected final String TEXT_1631 = NL + "\t\treturn getTypedValue();";
  protected final String TEXT_1632 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic ";
  protected final String TEXT_1633 = " setValue(";
  protected final String TEXT_1634 = " value)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1635 = " oldValue = getValue();";
  protected final String TEXT_1636 = NL + "\t\tgetTypedValue().clear();" + NL + "\t\tgetTypedValue().addAll(";
  protected final String TEXT_1637 = "(";
  protected final String TEXT_1638 = ")";
  protected final String TEXT_1639 = "value);";
  protected final String TEXT_1640 = NL + "\t\tsetTypedValue(value);";
  protected final String TEXT_1641 = NL + "\t\tsetTypedValue(((";
  protected final String TEXT_1642 = ")value).";
  protected final String TEXT_1643 = "());";
  protected final String TEXT_1644 = NL + "\t\tsetTypedValue((";
  protected final String TEXT_1645 = ")value);";
  protected final String TEXT_1646 = NL + "\t\treturn oldValue;" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_1647 = NL + "\t@SuppressWarnings(\"unchecked\")";
  protected final String TEXT_1648 = NL + "\tpublic ";
  protected final String TEXT_1649 = " getEMap()" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_1650 = " container = eContainer();" + NL + "\t\treturn container == null ? null : (";
  protected final String TEXT_1651 = ")container.eGet(eContainmentFeature());" + NL + "\t}" + NL;
  protected final String TEXT_1652 = NL + "\t/**" + NL + "\t * The parsed OCL expression for the body of the '{@link #";
  protected final String TEXT_1653 = " <em>";
  protected final String TEXT_1654 = "</em>}' operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
  protected final String TEXT_1655 = NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate static ";
  protected final String TEXT_1656 = "<";
  protected final String TEXT_1657 = "> ";
  protected final String TEXT_1658 = "BodyOCL;" + NL + "\t";
  protected final String TEXT_1659 = NL + "\t/**" + NL + "\t * The parsed OCL expression for the derivation of '{@link #";
  protected final String TEXT_1660 = " <em>";
  protected final String TEXT_1661 = "</em>}' property." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #";
  protected final String TEXT_1662 = NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate static ";
  protected final String TEXT_1663 = "<";
  protected final String TEXT_1664 = "> ";
  protected final String TEXT_1665 = "DeriveOCL;" + NL + "\t";
  protected final String TEXT_1666 = NL + "\tprivate static final String OCL_ANNOTATION_SOURCE = \"";
  protected final String TEXT_1667 = "\";";
  protected final String TEXT_1668 = NL + "\t" + NL + "\tprivate static final ";
  protected final String TEXT_1669 = " OCL_ENV = ";
  protected final String TEXT_1670 = ".newInstance();";
