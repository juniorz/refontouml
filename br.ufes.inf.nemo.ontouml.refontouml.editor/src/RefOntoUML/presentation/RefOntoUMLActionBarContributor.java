 ...
 * @generated
 */
public class RefOntoUMLActionBarContributor
	...
	implements ISelectionChangedListener
{
	...
	protected IAction showPropertiesViewAction =
		new Action(RefOntoUMLEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
		{
			@Override
			public void run()
			{
	...
	protected IAction refreshViewerAction =
		new Action(RefOntoUMLEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
		{
			@Override
	...
	{
		toolBarManager.add(new Separator("refontouml-settings"));
		toolBarManager.add(new Separator("refontouml-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager)
	{
		...
		IMenuManager submenuManager = new MenuManager(RefOntoUMLEditorPlugin.INSTANCE.getString("_UI_RefOntoUMLEditor_menu"), "RefOntoUMLMenuID");
		...
		//
		createChildMenuManager = new MenuManager(RefOntoUMLEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager)
	{
		...
		submenuManager = new MenuManager(RefOntoUMLEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(RefOntoUMLEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
